...
from email_alert import send_email_with_alert # <-- NEW IMPORT
        ...
        for face_encoding, face_location in zip(face_encodings, face_locations):
            ...
            if name == "Unknown":
                ...
                if is_new_unknown_face:
                    ...
                    # --- UPDATED: Capture filenames and then send email ---
                    # 1. Capture the images and get the list of filenames
                    saved_images = capture_alert_images(frame, face_location)
                    
                    # 2. Send those images in an email
